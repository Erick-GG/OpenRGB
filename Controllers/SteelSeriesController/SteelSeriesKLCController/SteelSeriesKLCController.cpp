...
{
    {0x04, 45}, {0x05, 62}, {0x06, 60}, {0x07, 47}, {0x08, 33}, {0x09, 48},
    {0x0a, 49}, {0x0b, 50}, {0x0c, 38}, {0x0d, 51}, {0x0e, 52}, {0x0f, 53},
    {0x10, 64}, {0x11, 63}, {0x12, 39}, {0x13, 40}, {0x14, 31}, {0x15, 34},
    {0x16, 46}, {0x17, 35}, {0x18, 37}, {0x19, 61}, {0x1a, 32}, {0x1b, 59},
    {0x1c, 36}, {0x1d, 58}, {0x1e, 17}, {0x1f, 18}, {0x20, 19}, {0x21, 20},
    {0x22, 21}, {0x23, 22}, {0x24, 23}, {0x25, 24}, {0x26, 25}, {0x27, 26},
...
{
    {0x28, 56}, {0x31, 43}, {0x32, -1}, {0x64, 75},
...
{
    {0x29,  0}, {0x2a, 29}, {0x2b, 30}, {0x2c, 73}, {0x2d, 27}, {0x2e, 28},
    {0x2f, 41}, {0x30, 42}, {0x33, 54}, {0x34, 55}, {0x35, 16}, {0x36, 65},
    {0x37, 66}, {0x38, 67}, {0x39, 44}, {0x66, 15}, {0xe0, 69}, {0xe1, 57},
    {0xe2, 72}, {0xe3, 71}, {0xe4, 76}, {0xe5, 68}, {0xe6, 74}, {0xf0, 70}
};
...
static const KLCKeyEntry KLC_FRAG4[19] =
{
    ...
    {0x46, 13}, {0x47, -1}, {0x48, -1}, {0x49, -1},
    {0x4a, -1}, {0x4b, 77}, {0x4c, 14},
    {0x4d, -1}, {0x4e, 78}, {0x4f, 82}, {0x50, 79}, {0x51, 80}, {0x52, 81}
};
